...
class _LoginScreenState extends State<LoginScreen> {
      ...
      body: Stack(
        children: [
          Positioned(
            ...
            child: _buildOrb(256, AppColors.primary.withValues(alpha: 0.10))),
          Positioned(
            bottom: MediaQuery.of(context).size.height * 0.15,
            right: MediaQuery.of(context).size.width * 0.05,
            child: _buildOrb(320, AppColors.tertiary.withValues(alpha: 0.10))),
          SafeArea(
            child: Center(
  ...
  Widget _buildHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.ctaGradientEnd, boxShadow: AppShadows.raised),
      child: Column(
        children: [
          Container(
            ...
            child: const Icon(Icons.shopping_cart,
                size: 72, color: AppColors.onSurface),
          ),
          // ── Greeting changes based on where user came from ────
          Text(
            _fromRegistration ? 'Account Created! 🎉' : 'Welcome back!',
            style: const TextStyle(fontFamily: 'Inter', fontSize: 22,
                fontWeight: FontWeight.bold, letterSpacing: -0.44,
                color: Colors.white)),
          ...
          Text(
            ...
            style: const TextStyle(fontFamily: 'Inter', fontSize: 14,
                fontWeight: FontWeight.w500, color: Color(0xCCFFFFFF))),
        ],
      ),
    );
  }
          ...
          child: Row(children: [
            ...
            GestureDetector(
              ...
              child: Icon(
                ...
                size: 22, color: AppColors.outlineVariant),
            ),
          ]),
        ),
      ],
          ...
          child: _isLoading
              ...
              : const Text('Sign In',
                  style: TextStyle(fontFamily: 'Inter', fontSize: 16,
                      fontWeight: FontWeight.bold, color: Color(0xFF04342C))),
        ),
      ),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            if (isGoogle)
              const Text('G', style: TextStyle(fontFamily: 'Inter',
                  fontSize: 14, fontWeight: FontWeight.w900,
                  color: Color(0xFF4285F4)))
            else
              const Icon(Icons.facebook, size: 22, color: Color(0xFF1877F2)),
            const SizedBox(width: 8),
            Text(isGoogle ? 'Google' : 'Facebook',
              style: const TextStyle(fontFamily: 'Inter', fontSize: 14,
