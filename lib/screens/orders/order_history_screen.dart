...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
            ...
            Row(children: [
              ...
              Expanded(child: Column(
                ...
                children: [
                  ...
                  Text(AppUtils.formatPrice(order.price),
                    style: const TextStyle(fontFamily: 'Inter',
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [AppColors.ctaGradientStart,
                      AppColors.ctaGradientEnd],
                    begin: Alignment.topLeft, end: Alignment.bottomRight),
                  borderRadius: BorderRadius.circular(999),
                  boxShadow: AppShadows.raised),
                child: const Center(
                  child: Text('Reorder This Item',
      ...
      body: ResponsiveLayout(
        child: StreamBuilder<List<OrderModel>>(
          ...
          builder: (context, snapshot) {
                    ...
                    delegate: SliverChildListDelegate([
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting &&
                        ...
                        ..._filteredOrders.asMap().entries.map((entry) {
                          final isLast = entry.key == _filteredOrders.length - 1;
                          return Padding(
            ...
            Positioned(bottom: 96, left: 24, right: 24,
  ...
  Widget _buildAppBar() {
    return Container(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 16),
        const Expanded(child: Text('Order History',
          style: TextStyle(fontFamily: 'Inter', fontSize: 18,
              fontWeight: FontWeight.bold, letterSpacing: -0.36,
              color: AppColors.onSurface))),
  ...
  Widget _buildSectionHeader() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        const Text('Past Transactions',
          style: TextStyle(fontFamily: 'Inter', fontSize: 24,
              fontWeight: FontWeight.w900, letterSpacing: -0.48,
              color: AppColors.onSurface)),
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(999),
            boxShadow: AppShadows.pressed),
          child: Text('${_filteredOrders.length} ORDERS',
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: config.dotGlow ? [BoxShadow(
              color: config.dotColor.withValues(alpha: 0.70),
              blurRadius: 8)] : null)),
        const SizedBox(width: 4),
        Text(config.label, style: TextStyle(fontFamily: 'Inter', fontSize: 10,
  ...
  Widget _buildDateRow(String date) {
    return Row(children: [
      ...
      Text(date, style: const TextStyle(fontFamily: 'Inter', fontSize: 12,
      ...
      children: [
        Expanded(child: Row(children: [
          ClipRRect(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(12),
                boxShadow: AppShadows.pressed),
              child: Image.network(order.productImageUrl, fit: BoxFit.cover,
                errorBuilder: (_, _, _) => Container(
                  color: AppColors.surfaceContainerLowest,
                  child: const Icon(Icons.image_outlined,
          ...
          Expanded(child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(order.productName, style: const TextStyle(
                  fontFamily: 'Inter', fontSize: 14,
                  fontWeight: FontWeight.bold,
                  color: AppColors.onSurface, height: 1.2)),
              const SizedBox(height: 2),
              const Text('Tap to view details', style: TextStyle(
        ...
        Text(AppUtils.formatPrice(order.price),
          style: const TextStyle(fontFamily: 'Inter', fontSize: 20,
              fontWeight: FontWeight.w900, color: AppColors.tertiary)),
      ],
    );
  }
  ...
  Widget _buildActionButtons(OrderModel order) {
    ...
    return Row(children: [
      Expanded(child: _buildActionButton(
        icon: Icons.replay, label: 'Reorder',
        onTap: () => _reorder(order))),
      const SizedBox(width: 16),
      Expanded(child: isShipped
        ? _buildActionButton(
        ...
        : _buildActionButton(
            icon: Icons.receipt_long_outlined, label: 'Details',
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        const Expanded(child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('NEED HELP?', style: TextStyle(fontFamily: 'Inter',
                fontSize: 11, fontWeight: FontWeight.bold,
                letterSpacing: -0.2, color: AppColors.primary)),
            SizedBox(height: 4),
            Text('Talk to SwiftBot about your deliveries.',
...
_StatusConfig _statusConfig(OrderStatus status) {
  switch (status) {
    case OrderStatus.delivered:
      return _StatusConfig(label: 'Delivered', textColor: AppColors.tertiary,
          dotColor: AppColors.tertiary, bgColor: AppColors.primaryContainer,
          dotGlow: true);
    case OrderStatus.shipped:
      return _StatusConfig(label: 'Shipped', textColor: AppColors.secondary,
          dotColor: AppColors.secondary, bgColor: const Color(0xFF015432),
          dotGlow: false);
...
class _StatusConfig {
  ...
  final bool dotGlow;
  const _StatusConfig({required this.label, required this.textColor,
      required this.dotColor, required this.bgColor, required this.dotGlow});
}
