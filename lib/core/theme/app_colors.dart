...
class AppColors {
  ...
  static const surfaceBright = Color(0xFF33443C); // Smoother Hover state
  static const surfaceContainerHigh = Color(
    0xFF22332C,
  ); // Slightly lighter for better contrast
  static const surfaceContainer = Color(0xFF16261E); // Neutral container
  ...
  // ── Shadow ────────────────────────────────────────────────────
  static const shadowDark = Color(0xFF060D0A); // Deeper, richer shadow anchor
